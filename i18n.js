...
const translations = {
    ja: {
        ...
        'circula-subtitle': 'キャンパスでの瞬間を、見逃さない',
        'circula-category': '（アプリ／Webデザイン）',
        'explore-more-btn': 'スポットライトの外側',
        'graphic-design-1-title': 'Branding Local Business in Melbourne',
        'graphic-design-1-category': '（グラフィックデザイン）',
        'graphic-design-1-desc': 'メルボルンのローカルビジネス向けのビジュアルアイデンティティとブランディング。地域の文脈に合わせたロゴ、カラー、タッチポイントを設計しました。',
        'graphic-design-2-title': 'Branding Activist Movement (Gender Inequality in Japan)',
        'graphic-design-2-category': '（グラフィックデザイン）',
        'graphic-design-2-desc': '日本のジェンダー不平等をテーマにしたアクティビストムーブメントのブランドデザイン。メッセージ、ビジュアルトーン、啓発・支援のための制作物を担当しました。',
        'shesaidk-subtitle': 'パーソナル・チャット採点',
        'shesaidk-category': '（個人ハッカソン）',
        'graphic-design-page-title': 'グラフィックデザイン',
        'graphic-design-page-desc': 'メインのUXケーススタディ以外のブランディング・ビジュアル作品。',
        'shesaidk-page-desc': '個人ハッカソンで取り組んだチャット採点ツール SheSaidK。Featured案件より軽めのサイドプロジェクトで、詳細は順次追加します。',
        'back-to-work': '• 作品一覧に戻る',
        'resume': 'レジュメを見る',
...
// Circula project
'circula-hero-subtitle': 'キャンパスでの瞬間を、見逃さない。',
'circula-hero-desc-1': 'Circulaは、大学内のクラブ活動やイベント情報を一元化し、リアルタイムで可視化するキャンパスマップ体験です。',
'circula-hero-desc-2': 'バラバラなグループチャットや掲示を追いかけなくても、「今、何があるか」を把握し、参加したい機会を見逃さず学内生活を最大化できることを目指しています。',
'circula-meta-type': 'タイプ',
'circula-meta-type-value': 'アプリ／Webデザイン',
'circula-meta-duration': '期間',
'circula-meta-duration-value': '継続中',
'circula-meta-role': '自分の役割',
'circula-meta-role-value': 'UXデザイナー／UXリサーチャー',
'circula-meta-tools': 'ツール',
'circula-meta-tools-value': 'Figma / Cursor / Framer',
'circula-challenge-title': 'キャンパス情報がバラバラ',
'circula-challenge-desc': 'イベントやサークル情報はSNS、メール購読、口コミに分散していて、キャンパスで「今、何が起きているか」を一目で把握しづらい状況でした。団体ごとにチケット取得や登録の手続きも異なり、その摩擦が機会を逃す原因となり、特に一年生や留学生にとって新しいコミュニティに入りにくさにつながっていました。',
'circula-discovery-title': '「知るタイミング」が遅い',
'circula-discovery-desc-1': '学生インタビューと観察から、多くの人が「後から知った」経験を共有していました。情報そのものより、発見のしやすさと信頼できる一覧性がボトルネックだと整理しました。',
'circula-discovery-desc-2': 'そこで',
'circula-discovery-desc-3': 'マップ上でこれからのイベントを見せる',
'circula-discovery-desc-4': '体験に集中してデザインすることにしました。',
'circula-research-title': 'キャンパスでの情報行動',
'circula-research-survey-title': '①アンケート・軽量リサーチ',
'circula-research-survey-1': '情報源',
'circula-research-survey-1-desc': 'InstagramやDiscord、メールが混在し、公式チャネルだけでは追いきれないという声が多くありました。',
'circula-research-survey-2': '参加の障壁',
'circula-research-survey-2-desc': '学生の63%が、場所が分からないことや、イベントが誰にでも開かれているか不安だと答えました。',
'circula-research-survey-3': '見逃した重要なイベント',
'circula-research-survey-3-desc': '初期リサーチ参加者の95%が、本当は参加したかったのに見逃したイベントがあると答えました。',
'circula-research-interview-title': '②インタビューからの示唆',
'circula-research-interview-1': '欲しい体験',
'circula-research-interview-1-desc': '「今このエリアで何があるか」を一目で知り、興味のあるイベントにすぐ飛べる導線を求めていました。',
'circula-research-interview-2': '運営側のニーズ',
'circula-research-interview-2-desc': 'サークル側も、届けたい層にリーチしやすい掲載・更新フローを重視していました。',
'circula-research-interview-3': '登録の手続き',
'circula-research-interview-3-desc': 'イベントごとに登録方法が異なるため、学生は慣れないイベントへの参加の仕方に戸惑いを感じていました。',
'circula-whatis-title': 'イベントとサークルが、このアプリひとつで',
'circula-whatis-desc': 'クラブ活動とイベントをマップ上に集約し、リアルタイムで状況を把握できるようにすることで、学生が参加したい機会を見逃さず、学内生活を最大化できる体験を目指しています。',
'circula-design-title': 'モバイルアプリでのイベント／サークル発見体験',
'circula-design-1-title': '2. スキャンしやすい階層',
'circula-design-1-desc': 'イベントカード、時間・場所・主催を一貫したパターンで提示し、移動中でも判断しやすくしました。',
'circula-design-2-title': '1. マップとリストの両方',
'circula-design-2-desc': '地理的な発見と、条件で絞り込む探索の両方に対応できるUIを意識しました。',
'circula-design-3-title': '3. 直感的な検索',
'circula-design-3-desc': '条件の絞り込みや検索の導線を整理し、どの操作から始めればよいか迷いにくいよう繰り返し調整しました。',
'circula-ux-title': '主要なユーザーフロー',
'circula-ux-flow1-title': '周辺のイベントを発見',
'circula-ux-flow1-desc': 'マップビューから近くの活動を探し、日時・場所などの詳細を開いて確認し、アプリから登録できるようにする想定です。',
'circula-ux-flow-list-title': 'リストビューでサッと探す',
'circula-ux-flow-list-desc': 'リストではこれからのイベントを時系列で表示し、「近日何があるか」を探したいときに並べ替えやフィルターで絞り込めます。詳細や登録の導線はマップビューと同じです。',
'circula-ux-flow2-title': '好きなサークルを見つける',
'circula-ux-flow2-desc': 'マップからサークルを探索し、詳細を開いて比較し、気になる団体を保存してあとから見返せる導線を設計しました。',
'circula-ongoing-section': '継続中のリサーチ',
'circula-ongoing-intro': '今後のアップデートに向けて、ターゲットユーザー20名以上からフィードバックを継続的に集めています。インタビューや軽いユーザビリティ確認に加え、利用後のアンケートで定性的・定量的な両面から学びを蓄積します。',
'circula-ongoing-qual-heading': 'アップデートで優先するフィードバック（定性）',
'circula-ongoing-qual-lead': '新機能の方向性を決めるうえで、いま注目しているテーマです。',
'circula-ongoing-qual-1': '「このアプリ上で友人や他の参加者と交流したい」という声。',
'circula-ongoing-qual-2': '「検索バーがキーワードからもっと関連性の高い候補を提案してほしい」という要望。',
'circula-ongoing-qual-3': '「プロフィールページをもっと自由にパーソナライズしたい」という声。',
'circula-ongoing-quant-heading': 'アンケートからの定量データ（利用後）',
'circula-ongoing-quant-lead': '利用後の簡易アンケートでは、SUS（System Usability Scale／システム使用性尺度）に加え、満足度やタスク成功の自己評価などの定量指標を追跡しています。',
'circula-sus-chart-caption': '提出された10件の回答から、各設問の平均スコア（1＝強く反対〜5＝強く賛成）を可視化しています。',
'circula-sus-chart-footnote': '✳はSUSで逆転させる項目（否定的な文）です。グラフの生スコアが低いほど、複雑さ・負担の体感は小さいことを意味します。最後の設問は尺度に加えたフォロー用の追加質問です。',
'circula-future-title': '振り返りと次のステップ',
'circula-future-like-title': '好き・得意と感じたところ：',
'circula-future-like-1': 'リサーチに基づいてUIの視認性と導線を磨き込むプロセス',
'circula-future-like-2': 'モバイルとWebを横断した一貫したデザインシステムの整理',
'circula-future-like-3': '学生向けプロダクトのペースで素早くプロトタイプを回すこと',
'circula-future-next-title': '今後していくこと：',
'circula-future-next-1': 'ユーザビリティテストの継続と計測に基づく改善',
'circula-future-next-2': '運営・サークル向けの更新フローのさらなる単純化',
'circula-future-next-3': '通知やパーソナライズの設計（プライバシーを踏まえて）',
        ...
        'reverie-design-3-title': '3. 直感的なボタンとナビゲーション',
        'reverie-design-3-desc': 'スライドバーボタン、シンプルなToDoリストとカレンダー、感情スケールにより、初日から主要なユーザーフローを理解しやすく設計しました。',
    ...
    en: {
        ...
        'circula-subtitle': 'Never miss a moment on Campus',
        'circula-category': '(App/Website design)',
        'explore-more-btn': 'Outside the Spotlight',
        'graphic-design-1-title': 'Branding Local Business in Melbourne',
        'graphic-design-1-category': '(Graphic design)',
        'graphic-design-1-desc': 'Visual identity and branding for a local business in Melbourne—logo, colour, and touchpoints tailored to the neighbourhood context.',
        'graphic-design-2-title': 'Branding Activist Movement (Gender Inequality in Japan)',
        'graphic-design-2-category': '(Graphic design)',
        'graphic-design-2-desc': 'Brand design for an activist movement addressing gender inequality in Japan—messaging, visual tone, and materials that support advocacy and awareness.',
        'shesaidk-subtitle': 'personal chat grader',
        'shesaidk-category': '(Personal hackathon)',
        'graphic-design-page-title': 'Graphic Design',
        'graphic-design-page-desc': 'Branding and visual work outside my main UX case studies.',
        'shesaidk-page-desc': 'A personal hackathon project—a chat grader built as a weekend side build, lighter than my featured case studies. Full write-up coming soon.',
        ...
        // Circula project
        'circula-hero-subtitle': 'Never miss a moment on Campus.',
        'circula-hero-desc-1': 'Circula is a campus map experience that centralizes club activities and event information and visualizes it in real time.',
        'circula-hero-desc-2': 'The goal is to help students from a variety of backgrounds see what is happening around them and get more from campus life—without chasing scattered information on Instagram.',
        'circula-meta-type': 'Type',
        'circula-meta-type-value': 'App / Website design',
        'circula-meta-duration': 'Duration',
        'circula-meta-duration-value': 'Ongoing',
        'circula-meta-role': 'My Role',
        'circula-meta-role-value': 'UX designer / UX researcher',
        'circula-meta-tools': 'Tools',
        'circula-meta-tools-value': 'Figma / Cursor / Framer',
        'circula-challenge-title': 'Campus information is fragmented',
        'circula-challenge-desc': 'Events and club updates lived across social media, subscribed emails, and word of mouth, making it hard to answer “what is happening now on campus?” at a glance. Events from different societies also followed different processes for tickets and registration. That friction led to missed opportunities and made it harder to join new communities, especially for first-year and international students.',
        'circula-discovery-title': 'People learn too late',
        'circula-discovery-desc-1': 'Through interviews and observation, many students shared “I only found out afterwards.” We reframed the problem around discoverability and trustworthy aggregation—not just more content.',
        'circula-discovery-desc-2': 'So we focused our design on ',
        'circula-discovery-desc-3': 'showing the upcoming events on a map ',
        'circula-discovery-desc-4': 'as the core experience.',
        'circula-research-title': 'How students find campus information',
        'circula-research-survey-title': '① Lightweight surveys',
        'circula-research-survey-1': 'Sources',
        'circula-research-survey-1-desc': 'Instagram, Discord, and email often overlapped; official channels alone were not enough to keep up.',
        'circula-research-survey-2': 'Barriers to joining',
        'circula-research-survey-2-desc': '63% of students mentioned not knowing where things happen and feeling unsure whether events were open to everyone.',
        'circula-research-survey-3': 'Missing key events',
        'circula-research-survey-3-desc': '95% of our initial research participants mentioned they had missed events that they would have loved to join.',
        'circula-research-interview-title': '② Interview insights',
        'circula-research-interview-1': 'Desired experience',
        'circula-research-interview-1-desc': 'People wanted to see what is happening in their area now and jump to details for events they care about.',
        'circula-research-interview-2': 'Organizer needs',
        'circula-research-interview-2-desc': 'Clubs also cared about reaching the right audience with a simple publishing and update flow.',
        'circula-research-interview-3': 'Registration process',
        'circula-research-interview-3-desc': 'Because of the varying registration methods for each event, students feel confused about how to attend some events they are not familiar with.',
        'circula-whatis-title': 'All the events and clubs in one app',
        'circula-whatis-desc': 'By bringing club activities and events onto a map and surfacing them in real time, Circula aims to help students avoid missing what they want to attend and make the most of campus life.',
        'circula-design-title': 'Event/club discovery experience on mobile app',
        'circula-design-1-title': '2. Scannable hierarchy',
        'circula-design-1-desc': 'Event cards follow a consistent pattern for time, location, and host so decisions are easy even on the move.',
        'circula-design-2-title': '1. Map and list together',
        'circula-design-2-desc': 'The UI supports geographic discovery and filtered browsing for different mental models.',
        'circula-design-3-title': '3. Intuitive search',
        'circula-design-3-desc': 'Filtering and search flows were refined so students can narrow down events quickly, with clearer entry points and feedback as they adjust criteria.',
        'circula-ux-title': 'Key user flows',
        'circula-ux-flow1-title': 'Discover what is nearby',
        'circula-ux-flow1-desc': 'From the map view, students can look for nearby activities, open details for timing and location, and register from the app.',
        'circula-ux-flow-list-title': 'Browse in list view',
        'circula-ux-flow-list-desc': 'The list layout shows upcoming events in chronological order, allowing students to sort and filter when they need to find what is happening soon, and open the same detail and registration paths as on the map.',
        'circula-ux-flow2-title': 'Find your favorite club',
        'circula-ux-flow2-desc': 'On the map, students explore clubs, open organiser details to compare options, and save the ones they want to follow so they can come back when they are ready.',
        'circula-ongoing-section': 'Ongoing research',
        'circula-ongoing-intro': 'To inform future updates, we keep collecting feedback from over 20 target users—through interviews, lightweight usability checks, and a post-experience questionnaire—so we learn from both qualitative and quantitative signals over time.',
        'circula-ongoing-qual-heading': 'Key feedback we are prioritizing (qualitative)',
        'circula-ongoing-qual-lead': 'Themes we are focusing on as we shape the next iterations.',
        'circula-ongoing-qual-1': '“I want to socialize with friends and other event attendees on this app.”',
        'circula-ongoing-qual-2': '“I wish the search bar suggested more relevant results from my keywords.”',
        'circula-ongoing-qual-3': '“I want to personalize the profile page more freely.”',
        'circula-ongoing-quant-heading': 'Quantitative data (post-questionnaire)',
        'circula-ongoing-quant-lead': 'After use, a short questionnaire captures quantitative measures, including the System Usability Scale (SUS), plus satisfaction and self-reported task success.',
        'circula-sus-chart-caption': 'Mean score per item from ten completed responses (1 = strongly disagree … 5 = strongly agree).',
        'circula-sus-chart-footnote': 'Items marked ✳ are negatively-loaded on the SUS; lower raw scores still reflect better perceived usability (e.g. low reported complexity). The last item is a custom follow-up question alongside the scale.',
        'circula-future-title': 'Reflection and next steps',
        'circula-future-like-title': 'What I liked and leaned into:',
        'circula-future-like-1': 'Tightening UI clarity and flows grounded in research',
        'circula-future-like-2': 'Keeping mobile and web aligned within a simple system',
        'circula-future-like-3': 'Shipping prototypes quickly in a student-led product rhythm',
        'circula-future-next-title': 'What is next:',
        'circula-future-next-1': 'More usability testing and iteration with usage signals',
        'circula-future-next-2': 'Simpler flows for clubs and organizers to publish updates',
        'circula-future-next-3': 'Thoughtful notifications and personalization with privacy in mind',
        ...
        'reverie-design-3-title': '3. Intuitive Buttons and Navigation',
        'reverie-design-3-desc': 'Slide-bar buttons, simple to-do list and calendar, as well as emotional state scale allow users to easily understand main user flows from day 1.',
